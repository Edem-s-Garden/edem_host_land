        ...
        <div id='contact_us' className={styles.container}>
            ...
            <div className={styles.form_container}>
                ...
                <form className={styles.form}>
                    ...
                    <input type='email' className={styles.input} name='email' placeholder='jonhDoe@example.mail'></input>
                    <label htmlFor='question'>YOUR QUESTION</label>
                    <textarea name='question' className={styles.question} placeholder='Type your question'></textarea>
